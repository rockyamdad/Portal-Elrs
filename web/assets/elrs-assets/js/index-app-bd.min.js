...
window.app = (function () {
    ...
    return {
        register: function (e, d) {
            b[e] = {creator: d, instance: null, callbacks: []};
            this.log('Registration: "' + e + '" was registered with the application core')
        }, start: function (f) {
            var e = b[f].creator, d = new Sandbox(this, f);
            ...
            b[d].callbacks.push({listenerName: e, callbackIndex: f});
...
(function (a) {
    app.register("module.authDialog", function (o) {
        var m, c, k = false, f = true, g = function () {
...
(function (a) {
    app.register("module.map", function (d) {
        var h, f, m, s, c = "#56a84d", g = "#91df88", n, j = function (x) {
            var w = x.attr("data-location-id");
            if (x.data("highlighted")) {
                r();
                i();
                d.notify("region unhighlighted", {locationID: w})
            } else {
                k(x);
                q(window.locationData[w]);
                d.notify("region highlighted", {locationID: w})
            }
        }, k = function (w) {
            ...
            h.delegate("path.region", "mouseenter mouseleave", function (w) {
                ...
                d.notify("map region clicked", {locationID: w})
    ...
    app.register("module.locationList", function (i) {
        var k, j, f = function (m, l) {
            if (l.type === "mouseenter") {
                i.notify("city link highlighted", {locationID: m.attr("data-location-id")})
            } else {
                i.notify("city link unhighlighted")
            }
        }, h = function (m, l) {
            if (l.type === "mouseenter") {
                i.notify("region link highlighted", {locationID: m.attr("data-location-id")})
            } else {
            ...
            var m = $("#region_" + n.locationID), l = m.attr("href");
...
(function (a) {
    ...
    b.register("module.utils", function (d) {
        var f, g = function (j, l, h, o, k, n) {
            ...
            var k = document.cookie.indexOf(j + "="), h = k + j.length + 1, i;
    ...
    a.prototype = {
        setup: function () {
            ...
            window.fbAsyncInit = function () {
                ...
                c = true;
                FB.init({appId: g, xfbml: true, version: window.facebook.version});
                if (b) {
...
(function (b) {
    ...
    a.prototype = {
        setup: function () {
            ...
            var h = "basic", j = null, g = null, d = (window.mobile_connect && window.mobile_connect.redirectUri) ? window.mobile_connect.redirectUri : "", k = null, c = null, e = (window.mobile_connect && window.mobile_connect.appID) ? window.mobile_connect.appID : "", i = (window.mobile_connect && window.mobile_connect.appSec) ? window.mobile_connect.appSec : "", f = (window.mobile_connect && window.mobile_connect.appUri) ? window.mobile_connect.appUri : "";
            ...
            if (b("#signinDropdown").length && window.location.protocol == "http:") {
                b("#btnMobileConnect").on("click", function () {
                    var d = window.location.search, e = "&mc=1";
                    if (d == "") {
                        e = "?mc=1"
                    }
